...
def _build() -> StateGraph:
    ...
    g.add_edge("clean_missing_rows", "encode_scale")
    g.add_edge("encode_scale", "set_goal")              # after the goal HITL checkpoint
    g.add_edge("set_goal", "feature_engineer")
    g.add_edge("feature_engineer", "sample")            # both the LLM-decision pass and the combine-consume pass land here
    g.add_edge("sample", "feature_select")
